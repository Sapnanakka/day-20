...
VALUES ('hema', 'bharatkumar', 'patani','it')";
$sql = "INSERT INTO student1(fname, mname,lname,branch)
VALUES ('jinal','sureshbhai','panchal','it')";
$sql = "INSERT INTO student1(fname, mname,lname,branch)
VALUES ('yash', 'mohanbhai', 'shakha','it')";
...
$sql = "UPDATE student1 SET mname='nakka' WHERE fname='sapna'";
